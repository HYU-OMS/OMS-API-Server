...
class Queue(Resource):
    ...
    def put(self):
        ...
        if 'action' not in body:
            return {"message": "'action' not provided!"}, 400
        ...
        with db_engine.connect() as connection:
            if action == 'deliver':
                ...
                return {"message": "'action' for 'cancel' is not implemented yet!"}, 501
            else:
                return {"message": "'action' must be either 'deliver' or 'cancel'!"}, 400
